...
namespace OOP_9
{
    class Program
    {
        ...
        {
            Func<string, string> DelegAll;//обобщенные делегаты 1.возвращает результат действия 2.
            Action<string> Act;
...
/*1)возможности определять вызываемый
метод не при компиляции, а динамически
во время выполнения программы;
►2)обеспечения связи между объектами по
типу «источник — наблюдатель»;
►3)создания универсальных методов, в
которые можно передавать другие
методы;
►4)поддержки механизма обратных
вызовов. */
